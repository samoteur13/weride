...
const myDetailsOfSteps = document.querySelectorAll('div .leaflet-right .leaflet-bar')
for (let i = 0; i < myDetailsOfSteps.length; i++) {
    myDetailsOfSteps[i].style.display = "none"
